...
public:
    ...
    static void simulated_annealing(Instance* instance, double T_start, double T_end,
                                    int epoch_length, double cooling_factor,
                                    void (*neighbourhood_type)(int* tour, int i1, int i2));
    static void genetic(Instance* instance, int population_size,
...
private:
    ...
    static void permute(Instance* instance, int* a, int l, int r, int64_t* best_tour_length,
                        int* best_tour);
